...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.option_get_place) {
            Toast.makeText(getApplicationContext(), "Découvrez le restaurant du mois.", Toast.LENGTH_SHORT).show();
    ...
    public void createNotification() {
        ...
        Notification noti = new Notification.Builder(this)
                ...
                .setContentText("Abonnez vous!").setSmallIcon(R.drawable.common_google_signin_btn_icon_dark)
            ...
            public void onResponse(Call<PlacesPOJO.Root> call, Response<PlacesPOJO.Root> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (root.status.equals("OK")) {
                        ...
                        Toast.makeText(getApplicationContext(), "Aucun restaurant trouvé en rapport avec votre demande", Toast.LENGTH_SHORT).show();
                    }

                } else if (response.code() != 200) {
                    Toast.makeText(getApplicationContext(), "Erreur " + response.code() + " trouvé.", Toast.LENGTH_SHORT).show();
                }
                ...
                if (permissionsRejected.size() > 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            showMessageOKCancel("Ces autorisations sont obligatoires pour l'application. S'il vous plait autorisez l'accès.",
